...
export const getIsOwnerSelector = (state: appStateType): boolean => state.profile.isOwner
...
export const getFullNameSelector = (state: appStateType): string => state.profile.fullName
export const getContactsSelector = (state: appStateType): contactsTypes => state.profile.contacts
export const getUserIdSelector = (state: appStateType): number | null => state.auth.userId
export const getIsLoadingSelector= (state: appStateType): boolean => state.profile.isLoading