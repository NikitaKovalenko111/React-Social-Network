    ...
    return (
        <div>
            <Formik
                initialValues={{
                    term: term,
                    friend: friend !== undefined ? friend : null,
                }}
                enableReinitialize
                ...
                {({
                    ...
                    <Form onFinish={handleSubmit}>
                        <div style={{ display: 'flex' }}>
                            ...
                            <Select
                                defaultValue={
                                    values.friend === 0 || values.friend === 1
                                        ? String(values.friend)
                                        : null
                                }
                                style={{ width: 165 }}
                                onChange={(value) => {
...
const Users: React.FC<props> = (): JSX.Element => {
    ...
    const actualFriend = query.has('friends')
        ? Number(query.get('friends'))
        : undefined
    const actualTerm = query.has('term') ? query.get('term') : ''
